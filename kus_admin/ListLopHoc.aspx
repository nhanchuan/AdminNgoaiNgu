<%@ Page Title="" Language="C#" MasterPageFile="~/GlobalMasterPage.master" AutoEventWireup="true" CodeFile="ListLopHoc.aspx.cs" Inherits="kus_admin_ListLopHoc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <!-- BEGIN PAGE HEADER-->
    <h1 class="page-title">Danh Sách Lớp Học
    </h1>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="../kus_admin/ListLopHoc.aspx">DS Lớp</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <a href="../kus_admin/MoLopHoc.aspx" class="btn green">Mở lớp học mới</a>
        </div>
                ...
                <div class="portlet-body background">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <a class="btn btn-default" href="#modalGiaoTrinhHoc" data-toggle="modal"><i class="fa fa-book"></i>Sách - Giáo trình học</a>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        <div class="col-lg-12">
                            <asp:GridView ID="gwListLopHoc" CssClass="table table-condensed" runat="server" AutoGenerateColumns="False" RowStyle-BackColor="#A1DCF2" Font-Names="Arial" Font-Size="10pt" OnRowDataBound="gwListLopHoc_RowDataBound" OnRowDeleting="gwListLopHoc_RowDeleting"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sỉ Số Tối Đa">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("SiSoToiDa") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label6" runat="server" Text='<%# Bind("SiSoToiDa") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
